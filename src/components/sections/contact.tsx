    ...
    <section id="contact" className="py-24 relative">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
          <div className="glass-card p-8 animate-fade-up h-full flex flex-col">
            ...
            {isSubmitted ? (
              <div className="flex flex-col items-center justify-center flex-grow text-center p-8">
                <div className="w-20 h-20 bg-stellar-blue/10 rounded-full flex items-center justify-center mb-6">
                  <svg 
                    xmlns="http://www.w3.org/2000/svg" 
                    className="w-10 h-10 text-stellar-blue" 
                    fill="none" 
                    viewBox="0 0 24 24" 
                    stroke="currentColor"
                  >
                ...
                <h4 className="text-2xl font-semibold mb-2 text-white">Message Sent!</h4>
                <p className="text-white/80 max-w-md">
                  Thank you for reaching out. We've received your message and will get back to you within 24 hours.
                </p>
                <button
                  onClick={() => setIsSubmitted(false)}
                  className="mt-6 px-6 py-2 rounded-lg bg-stellar-blue/10 hover:bg-stellar-blue/20 text-stellar-blue border border-stellar-blue/30 transition-colors"
                >
              ...
              <form onSubmit={handleSubmit} className="flex-grow flex flex-col">
                ...
                <button
                  ...
                  className="w-full mt-6 py-3 rounded-lg bg-stellar-blue hover:bg-stellar-blue/90 text-white font-medium transition-all stellar-shadow hover:translate-y-[-2px] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center"
                >
                  {isSubmitting ? (
                    <>
            ...
            <div className="glass-card p-8 h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-12 h-12 rounded-full bg-stellar-blue/10 flex items-center justify-center text-stellar-blue mr-4 shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">Bengaluru, Karnataka, India</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">+91 8122211194</p>
                    <p className="text-sm text-white/60 mt-1">Mon-Fri, 9am-5pm IST</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">info@stellarixspace.com</p>
